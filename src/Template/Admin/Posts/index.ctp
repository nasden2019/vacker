						...
						<div class="col-md-12 row">
							<div class="col-xs-12 col-md-4">
								<div class="form-group col-xs-12">
									<input type="text" name="search" class="form-control" placeholder="Título" value="<?php if(!empty($this->request->query['search'])) echo $this->request->query['search']; ?>">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-md-4">
			...
			<div class="card-body">
				<div class="row">
		            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
		              	<h2 class="page-header" style="margin-top: 0px;"><i class='fa fa-balance-scale'></i> Listado de Posts</h2>
		              	<address>
		                <?= (!empty($this->request->query['search']))? 'Título: '.$this->request->query['search'].'<br>' : ''; ?>
		              	</address>
		            </div>
		        </div>
			</div>
				...
				<table class="table table-hover">
					<thead>
						<tr>
							...
							<th><?= $this->Paginator->sort('title', 'Título del Post'); ?></th>
